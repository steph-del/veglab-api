...
/**
 * @extends ServiceEntityRepository<SyntheticColumn>
 *
...
class SyntheticColumnRepository extends ServiceEntityRepository
{
    ...
    public function save(SyntheticColumn $entity, bool $flush = false): void
    {
    ...
    public function remove(SyntheticColumn $entity, bool $flush = false): void
    {
